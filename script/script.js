...
let a = document.querySelector(':root'),
    ...
    body = document.querySelector('.yellow'),
    comp = getComputedStyle(body, "-webkit-scrollbar-thumb")
...
color.addEventListener('click', () => {
    ...
    if (color.classList.contains('green')) {
        ...
        body.style = `background: linear-gradient(124.13deg, #F4CB38 10.97%, #F4A938 77.98%)`
